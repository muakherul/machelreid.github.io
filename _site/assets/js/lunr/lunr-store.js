var store = [{
        ...
        "excerpt":"Introduction Generally, when we think about generation in NLP, we think of it as going from left-to-right (or right-to-left) – i.e. you generate one token at a time. For example, take this diagram of this language model below: [diagram] You can see that the prediction of the word word is...","categories": [],
        "tags": [],
        "url": "http://localhost:4000/2020/08/19/a-simple-guide-to-non-autoregressive-machine-translation.html",
        "teaser": null
      }]
